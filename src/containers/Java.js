...
const Java = () => {
  const questions = [
    ...
    },
    {
      ...
      answer: 'A Java Virtual Machine is responsible for converting byte code into machine readable code.'
    },
    {
    ...
    },
    {
      ...
      answer: 'When you have more than one method with the same name in a single class, but the arguments are different.'
    },
    {
      question: 'What is the "final" keyword?',
      answer: 'The "final" keyword is used in classes to make sure no other class can extend it. It is used for methods to make sure that child classes can not override it. It is used with variables to make sure that they can only be assigned once.'
    }
  ]
